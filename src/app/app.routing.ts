...
export const routes: Routes = [
  {
    ...
    children: [
      {
        path: '', redirectTo: 'dashboard/analytics', pathMatch: 'full',canActivate: [AuthService]
      },
      {
        path: 'dashboard',
      ...
      {
        path: 'sigma',
        loadChildren: 'app/shared/forms/sigma/dynamic-form/dynamic-form.module#DynamicFormModule',
        data: {pageTitle: 'Forms'}
      },
      {
        path: 'commons',
        loadChildren: 'app/commons/commons.module#CommonsModule',
        data: {pageTitle: 'Commons'}
      },
      {
        path: 'askrindo',
        loadChildren: 'app/askrindo/askrindo.module#AskrindoModule',
        data: {pageTitle: 'Askrindo'}
      },
    ]
  },
