...
export class OutlookService {
  ...
  getOutlook(): Observable<Outlook> {
    return this.jsonApiService.unsecureGet('/outlook/outlook.json')
  }

  getMessages(folder: string) {

    this.jsonApiService.unsecureGet('/outlook/' + folder + '.json')
  ...
  getMessage(id: string) {
    return this.jsonApiService.unsecureGet('/outlook/message.json')
  }
